...
const Header = () => {
  return (
    <header className="p-2 flex justify-between items-center w-[96%] md:w-[92%] max-w-[1400px] z-50 absolute top-brand-spacing-sm left-1/2 -translate-x-1/2 bg-background rounded-brand-radius">
      <Badge className="" />
