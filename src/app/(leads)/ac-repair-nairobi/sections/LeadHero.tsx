...
export default function LeadHero() {
  return (
    <div className="min-h-[60vh] md:min-h-[65vh] flex flex-col items-center justify-center from-neutral to-background bg-linear-to-t">
      <SectionContainer className="translate-y-1/4">
        <div className="flex flex-col gap-brand-spacing-xs max-w-190">
          ...
          <p className="max-w-130">
            ...
            Dealers in cold room, air-conditioner installation, repair and maintenance
          </p>
          <a
            href={`tel:${contact.info.phone1}`}
            target="_blank"
            rel="noopener noreferrer"
            className="hover:scale-105 mt-2 duration-300 ease-in font-semibold flex items-center gap-2 stroke-brand-white p-3 rounded-brand-radius w-fit bg-primary text-brand-white"
          >
            Call For Immediate AC Repair
            <LeadPhoneIcon />
          </a>
        </div>
      </SectionContainer>
