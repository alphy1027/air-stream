...
const buttonVariants = cva(
  "tracking-wide whitespace-nowrap disabled:brightness-90 disabled:cursor-not-allowed disabled:opacity-60 flex w-fit py-3 px-8 h-fit text-body-lg items-center capitalize justify-center rounded-brand-radius font-semibold cursor-pointer hover:scale-105 active:scale-95 transition-all duration-200 ease-in-out gap-x-4",
  {
    variants: {
      variant: {
