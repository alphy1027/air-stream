...
export default function InstantContact({ title, icon, href, body }: ContactProps) {
  return (
    <a
      ...
      className="flex flex-col gap-brand-spacing-sm rounded-brand-radius bg-neutral border border-foreground-borders py-brand-spacing-sm lg:py-brand-spacing lg:px-brand-spacing-lg px-brand-spacing hover:scale-105 duration-200 transition ease-in group hover:bg-accent hover:border-none active:bg-accent active:border-none"
    >
